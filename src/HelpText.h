...
HelpPair gHelpText[] = {
   ...
   { "monoRelProb", "Determines whether probabilities in mono mode are displayed as independent weights or relative percentage of the total weight in the column."},
    {0,0} // end sentinel
};
